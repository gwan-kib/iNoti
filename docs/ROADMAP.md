...
Status: documentation only. Build tooling, CI, extension components, and live iClicker investigation remain pending. There is no installable extension or released version.
...
- [Decisions](DECISIONS.md): chosen directions and pending tooling, audio, settings, minimum Chrome version, and OS support decisions.
