...
- PiP receives generic idle/active/ended display calls and local start/end detection times only. Text is rendered with textContent; no question content, identifiers, external fonts, network requests, or telemetry are introduced.
