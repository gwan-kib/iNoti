...
- **Current command status:** none of these commands exists yet. The tooling change must define exact commands in README.md, CONTRIBUTING.md, and docs/TESTING.md and configure equivalent CI checks. Do not invent passing commands, create placeholder tests to imply coverage, or claim the tooling portion of Phase 0 is complete.
